                    ...
                    {stores.map((s) => (
                      <tr key={s.id} className="border-b border-slate-50 transition hover:bg-slate-50 dark:border-slate-700 dark:hover:bg-slate-800/50">
                        <td className="py-3 pr-4">
                          <button onClick={() => openStoreDetail(s.id, s.name)} className="font-medium text-indigo-600 hover:underline dark:text-indigo-400">
                            {s.name}
                          </button>
                        </td>
                        ...
                        <td className="py-3 text-right">
                          <button onClick={() => openStoreDetail(s.id, s.name)} className="rounded p-1.5 text-indigo-600 hover:bg-indigo-50 dark:text-indigo-400 dark:hover:bg-indigo-900/30" title="Details">
